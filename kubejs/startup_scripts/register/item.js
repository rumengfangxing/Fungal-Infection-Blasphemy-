StartupEvents.registry('item', event => {
	...
	event.create('fib:bio_equipment_module').rarity('epic')
	event.create('fib:bio_equipment_module_0').glow(true).rarity('epic')
	event.create('fib:h_a_equipment_module').rarity('epic')
	event.create('fib:spec_equipment_module').rarity('epic')
	event.create('fib:echo_equipment_module').rarity('epic')
	event.create('fib:avi_equipment_module').rarity('epic')
	...
	event.create('fib:hex_essence').glow(true)
