ServerEvents.recipes(event =>{
    ...
    create.mixing(['spore:cerebrum',
        ...
        [Fluid.water(400),'biomancy:nutrient_paste','spore:cerebrum']).heated()
    ...
    create.mixing([Item.of('spore:mutated_fiber',4),
        ...
        Item.of('spore:mutated_fiber').withChance(0.25),
        Item.of('spore:mutated_fiber').withChance(0.25)],
        [Fluid.water(400),'biomancy:nutrient_paste','spore:mutated_fiber','biomancy:hormone_secretion']).heated()
    ...
    create.mixing([Item.of('spore:organoid_membrane',3),
        ...
        Item.of('spore:organoid_membrane').withChance(0.25)],
        [Fluid.water(400),'biomancy:nutrient_paste','spore:organoid_membrane','biomancy:hormone_secretion']).heated()

    //翼膜
    create.mixing([Item.of('spore:wing_membrane',3),
        Item.of('spore:wing_membrane').withChance(0.25),
        Item.of('spore:wing_membrane').withChance(0.25)],
        [Fluid.water(400),'biomancy:nutrient_paste','spore:wing_membrane','biomancy:hormone_secretion']).heated()
    ...
    create.mixing([Item.of('spore:armor_fragment',4),
        ...
        Item.of('spore:armor_fragment').withChance(0.25),
        Item.of('spore:armor_fragment').withChance(0.25)],
        [Fluid.water(400),'biomancy:nutrient_paste','spore:armor_fragment','biomancy:hormone_secretion','minecraft:bone_meal']).heated()

    //利爪残片
    create.mixing([Item.of('spore:claw_fragment',3),
        Item.of('spore:claw_fragment').withChance(0.25),
        Item.of('spore:claw_fragment').withChance(0.25)],
        [Fluid.water(400),'biomancy:nutrient_paste','spore:claw_fragment','biomancy:hormone_secretion','minecraft:bone_meal']).heated()

    //遗传化合物
    //突变心脏
    create.mixing([Item.of('spore:mutated_heart',2),
        Item.of('spore:mutated_heart').withChance(0.25)],
        [Fluid.water(400),'biomancy:nutrient_paste','spore:mutated_heart','biomancy:genetic_compound']).heated()

    //腐化性囊
    create.mixing([Item.of('spore:corrosive_sack',2),
        Item.of('spore:corrosive_sack').withChance(0.25),
        Item.of('spore:corrosive_sack').withChance(0.25)],
        [Fluid.water(400),'biomancy:nutrient_paste','spore:corrosive_sack','biomancy:genetic_compound','biomancy:withering_ooze']).heated()

    //肺泡状囊
    create.mixing([Item.of('spore:alveolic_sack',2),
        Item.of('spore:alveolic_sack').withChance(0.25),
        Item.of('spore:alveolic_sack').withChance(0.25)],
        [Fluid.water(400),'biomancy:nutrient_paste','spore:alveolic_sack','biomancy:genetic_compound']).heated()

    //变异脾脏
    create.mixing([Item.of('spore:altered_spleen',2),
        Item.of('spore:altered_spleen').withChance(0.25)],
        [Fluid.water(400),'biomancy:nutrient_paste','spore:altered_spleen','biomancy:genetic_compound']).heated()
