...
(function() {
    ...
    var NEWS_POOL = [ 
        ...
        "某聚居地居民联名上书,要求公开§c造神计划§r全部档案,官方回应:现有档案仅有少数幸存的受害者提供,没有更多信息了",
        ...
        "匿名来源流出所谓'造神计划第27号实验记录',内容涉及'嫁接人类意识与菌群感知'的尝试——罗德岛对关于该技术的提问拒绝置评",
    ...
    var TIPS_POOL = [
        ...
        "死在野外不可怕,可怕的是你为了一次死亡的代价付出N次死亡的代价",
        "钱存在银行里会涨利息哦",
        ...
        "它们不能在文明区中生成,且会主动逃离文明区,但对精英单位不会遵守文礼",
        "防患于未然,需要丰富的经验",
        "今日运势:大吉",
        "今日运势:吉",
        "今日运势:小吉",
